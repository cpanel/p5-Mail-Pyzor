...
See F<https://github.com/cpanel/p5-Mail-Pyzor/issues> to report and view bugs.

=head1 SOURCE

The source code repository for Mail::Pyzor can be found at F<https://github.com/cpanel/p5-Mail-Pyzor>.
